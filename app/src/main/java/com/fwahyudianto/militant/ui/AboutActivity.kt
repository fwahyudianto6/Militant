...
class AboutActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val urlDevPhoto = resources.getString(R.string.developer_photo)
        Glide.with(this)
            .load(urlDevPhoto)
            .into(findViewById(R.id.developer_img))

        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.main_sv_player_detail)) { v, insets ->
